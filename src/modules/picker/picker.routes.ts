...
import { authenticatePicker, authenticatePickerAllowSuspended, requireActivePicker } from './picker.auth.middleware';
...
// ─── Profile ──────────────────────────────────────────────────────────────────
router.get('/user/profile/link-status', ...authed, ctrl.getLinkStatus);
router.get('/user/profile/contract', ...authed, ctrl.getUserContract);
router.put('/user/profile/contract', ...authed, ctrl.updateUserContract);
router.get('/user/profile/employment', ...authed, ctrl.getEmployment);
router.put('/user/profile/employment', ...authed, ctrl.updateEmployment);
router.get('/user/profile/overview', ...authed, ctrl.getProfileOverview);
router.get('/user/profile', ...authed, ctrl.getProfile);
router.put('/user/profile', ...authed, validate(v.workforceUpdateProfileSchema), ctrl.updateProfile);
router.put('/user/location-type', ...authed, validate(v.setLocationTypeSchema), ctrl.setLocationType);
router.put('/user/upi', ...authed, validate(v.setUpiSchema), ctrl.setUpi);
router.get('/profile', ...authed, ctrl.getRiderProfile);
router.put('/profile', ...authed, validate(v.updateProfileSchema), ctrl.updateRiderProfile);
